    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Data Stok Masuk Barang Perlengkapan</h5>

                        <a href="/barang-masuk/form" type="button" class="btn btn-sm"
                                ...
                                @foreach ($barangmasuk as $data)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if ($data->status == 0)
                                                <a href="/barang-masuk/status_masuk/{{ $data->id }}" type="button"
                                                    class="btn btn-success btn-sm"><i class="bi bi-check-lg"></i></a>
                                            @else
                                            @endif

                                            <a href="/barang-masuk/edit/{{ $data->id }}" type="button"
                                                class="btn btn-sm" style="background-color: #05b3c3; color:#FFFFFF"><i
                                                    class="bi bi-pencil delete"></i></a>
                                            <a href="/barang-masuk/hapus/{{ $data->id }}"
