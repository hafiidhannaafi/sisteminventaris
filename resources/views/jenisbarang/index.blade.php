                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form name="inputjenisbarang" action="{{ route('inputjenisbarang') }}"
                            ...
                            @foreach ($jenisbarang as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/jenisbarang/edit/{{ $data->id }}" type="button" class="btn btn"
                                            style="background-color: #05b3c3; color:#FFFFFF"><i
                                                class="bi bi-pencil"></i></a>
                                        <a href="/jenisbarang/hapusjenisbarang/{{ $data->id }}"
