                                ...
                                @foreach ($peminjaman as $data)
                                    ...
                                    @if ($status->status_konfirmasis_id == 1 ||
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($status->status_konfirmasis_id == 2 && $status->status_peminjamans_id == 1)
                                                    <!--STATUS PEMINJAMAN  -->
                                                ...
                                                @else
                                                    <span class="badge border-dark border-1 text-dark small fst-italic"
                                                        style="color:#012970;"> barang sudah
                                                        diambil</span>
                                                @endif


                                                @if ($status->status_konfirmasis_id == 2 && $status->status_peminjamans_id == 2)
                                                    <!--STATUS PENGEMBALIAN-->
