...
<head>
    ...
    <title>Edit akun staff- Sistem Inventaris dan Peminjaman Barang LPTP</title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">Edit Akun staff</h5>
                        ...
                        <div class="invalid-feedback">Please enter your password!</div>
                                        ...
                                        <div class="col-12">
                                            <button class="btn btn w-100"
                                                style="background-color: #494cf6; color:#FFFFFF" type="submit">
                                                submit</button>
                                        </div>
                                        {{-- <div class="col-12">
